      ...
      <div className="flex flex-col md:flex-row items-start justify-center px-6 md:px-16 lg:px-32 gap-10 py-14 border-b border-gray-500/30 text-gray-500">
        <div className="w-4/5">
          ...
          <p className="mt-6 text-sm">
            Bringing you fresh, trendy, and customizable t-shirts that let you express yourself your way. Premium quality t-shirts designed with care. We customize, print, and deliver styles that fit your personality.
          </p>
        </div>
